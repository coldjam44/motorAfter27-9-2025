<?php
// محاكاة POST request لتحويل الصورة بدون امتداد إلى WebP
...
echo "=== بدء عملية تحويل الصورة بدون امتداد إلى WebP ===\n";
echo "الملف: {$_POST['found_file']}\n";
echo "نوع الصورة: {$_POST['image_type']}\n";
echo "ID الإعلان: {$_POST['ad_id']}\n";
echo "=====================================\n\n";

// تضمين ملف التحويل للصور بدون امتداد
ob_start();
include 'convert_to_webp_no_ext.php';
$output = ob_get_clean();
